...
$experience = [
    [
        ...
        'options' => 'подметал дворы, кормил кошек'
    ],
    [
        'position' => 'старший дворник',
        'company' => 'ЖЭК№2',
        'date' => 'Mar 2014 - Dec 2016',
        'options' => 'подметал дворы, кормил кошек, кормил собак'
    ],
    [
        'position' => 'главный дворник',
        'company' => 'ЖЭК№12',
        'date' => 'Mar 2016 - Dec 2020',
        'options' => 'заставлял других дворников кормить кошек и собак'
    ],
];
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h5 class="w3-opacity"><b><?php echo $experience[$i]['position']?>/<?php echo $experience[$i]['company']?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]['date']?> <span
            <p><?php echo $experience[$i]['options']?></p>
            <hr>
            <?php endfor;?>
          </div>
        </div>
